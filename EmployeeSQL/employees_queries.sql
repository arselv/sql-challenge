...
SELECT
	dept_managers.dept_no, departments.dept_name, employees.emp_no, employees.last_name, employees.first_name
	FROM dept_managers
...
-- Sales departments tied to dept_emp by dept_no,  and then tied to employees by emp_no
SELECT
